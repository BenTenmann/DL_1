...
import pandas as pd
T = pd.DataFrame({"epochs":list(range(1,epochs+1)), "error":epoch_error})
T.to_csv("/Users/benjamintenmann/Desktop/CompBio/Assignments/DL_1/MLP/noalpha.csv", index=False)
